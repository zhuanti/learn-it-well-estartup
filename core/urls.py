...
urlpatterns = [
    ...
    path('Sroominpage-self/', report_review_views.get_reviews_insideshow),  # 個人自習室內部新增時間
    path('Sroominpage-self/existtime/', report_review_views.self_exittime),  # 個人自習室內部離開時間
